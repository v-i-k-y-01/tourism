...
const DESTINATIONS: Record<Collection, { name: string; region: string; image: string }[]> = {
  Domestic: [
    { name: "Wayanad", region: "Kerala", image: "https://images.unsplash.com/photo-1627060938622-7f27ac14878a?auto=format&fit=crop&w=900&q=85" },
    ...
    { name: "Kochi", region: "Kerala", image: "https://images.unsplash.com/photo-1589308078059-be1415eab4c3?auto=format&fit=crop&w=900&q=85" },
    ...
    { name: "Varkala", region: "Kerala", image: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=900&q=85" },
    ...
    { name: "Gokarna", region: "Karnataka", image: "https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=900&q=85" },
    ...
    { name: "Goa", region: "Goa", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=85" },
    ...
    { name: "Kodaikanal", region: "Tamil Nadu", image: "https://images.unsplash.com/photo-1580618672591-eb180b1a973f?auto=format&fit=crop&w=900&q=85" },
    { name: "Pondicherry", region: "Tamil Nadu", image: "https://images.unsplash.com/photo-1590050752117-238cb061295a?auto=format&fit=crop&w=900&q=85" },
  ],
  International: [
    ...
    { name: "Thailand", region: "Southeast Asia", image: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?auto=format&fit=crop&w=900&q=85" },
  ...
  Special: [
    { name: "Family Tour", region: "Made for every generation", image: "https://images.unsplash.com/photo-1502086223501-7ea6ecd79368?auto=format&fit=crop&w=900&q=85" },
    { name: "Honeymoon Tour", region: "Made for two", image: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=900&q=85" },
    { name: "Educational Tour", region: "Made to inspire", image: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=900&q=85" },
